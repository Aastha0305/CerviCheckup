...
def predict_datapoint():
    if request.method == 'GET':
        ...
        data = CustomData(
            Number_of_sexual_partners=int(request.form.get('Number_of_sexual_partners')),
            ...
            Hormonal_Contraceptives_years=float(request.form.get('Hormonal_Contraceptives_years')),
            ...
            STDs_cervical_condylomatosis=int(request.form.get('STDs_cervical_condylomatosis')),
            STDs_vaginal_condylomatosis=int(request.form.get('STDs_vaginal_condylomatosis')),
            STDs_vulvo_perineal_condylomatosis=int(request.form.get('STDs_vulvo_perineal_condylomatosis')),
            STDs_syphilis=int(request.form.get('STDs_syphilis')),
            STDs_pelvic_inflammatory_disease=int(request.form.get('STDs_pelvic_inflammatory_disease')),
            STDs_genital_herpes=int(request.form.get('STDs_genital_herpes')),
            STDs_molluscum_contagiosum=int(request.form.get('STDs_molluscum_contagiosum')),
            ...
            STDs_Time_since_first_diagnosis=float(request.form.get('STDs_Time_since_first_diagnosis')),
            STDs_Time_since_last_diagnosis=float(request.form.get('STDs_Time_since_last_diagnosis')),
